...
folder='/home/pinguinson/images/screenshots'
...
test -n "$link" && (printf $link | xclip -selection clipboard; printf "\a") || echo "$res" > "$img.error"
notify-send "screenshot saved" "$link";echo "screenshot saved: $link"